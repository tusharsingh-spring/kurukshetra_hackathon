...
data class BitchatMessage(
    ...
    /**
     * Emergency-response category attached to broadcast messages. The sender's announced
     * [Role] rides with the message via [BinaryProtocol.Flags.HAS_CATEGORY]. Recipients
     * filter locally by [ChatState.subscribedRoles] to hear only the responder roles they
     * care about. [Role.UNSET] means legacy / no role declared and is always shown.
     */
